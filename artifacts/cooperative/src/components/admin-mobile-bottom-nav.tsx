...
export function AdminMobileBottomNav() {
  ...
  const tabs: Tab[] = [
    ...
    { href: "/members", icon: <Users className="w-5 h-5" />, label: "Members" },
    { href: "/loans", icon: <CreditCard className="w-5 h-5" />, label: "Loans" },
    { href: "/upload", icon: <FileSpreadsheet className="w-5 h-5" />, label: "Upload" },
              ...
              {tab.more ? (
                <Sheet open={moreOpen} onOpenChange={setMoreOpen}>
                  ...
                  >
                    ...
                    <div className="mt-5">
                      <p className="px-1 text-[10px] uppercase font-semibold tracking-wider text-muted-foreground mb-2">
                        Administration
                      </p>
                    ...
                    {canInstall && (
                      <div className="mt-5">
                        <button
                          ...
                          data-testid="admin-more-install-app"
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-2">
                      <Button
                        ...
                        onClick={toggleTheme}
                        data-testid="admin-more-toggle-theme"
                      >
                        {theme === "dark" ? (
                          <>
                      ...
                      <Button
                        ...
                        data-testid="admin-more-sign-out"
                      >
                ...
                <Link
                  href={tab.href!}
                  data-testid={`admin-bottom-nav-${tab.label.toLowerCase()}`}
                >
                  {content}
                </Link>
              )}
